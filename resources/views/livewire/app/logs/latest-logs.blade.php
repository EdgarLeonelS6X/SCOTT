    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden flex flex-col h-[428px]">
        ...
        <div class="relative" style="height: 320px; max-height: 320px; min-height: 0;">
            <div id="logs-container" wire:poll.2000ms="fetchLogs"
                class="overflow-y-auto font-mono text-[12px] leading-relaxed px-2 pt-2 pb-8 space-y-1 bg-gray-50 dark:bg-gray-800 h-full"
            ...
            <button
                ...
                class="absolute bottom-2 right-2 z-30 bg-primary-600 hover:bg-primary-700 bg-opacity-80 text-white rounded-full shadow-lg p-2 transition-all duration-200 flex items-center justify-center"
