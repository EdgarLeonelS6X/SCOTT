    ...
    <form wire:submit.prevent="saveReport" class="space-y-5">
        ...
        <div class="flex items-start">
            <div class="flex items-center h-5">
                <input type="checkbox" x-model="status" wire:model="reportData.chromecast.status"
            ...
            <div class="ml-3 text-sm">
                <label class="flex items-center">
                    <span x-text="status ? 'We proceed to write a problem.' : 'No problems found.'"></span>
                </label>
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row justify-end gap-4 mt-6">
            <button type="submit"
                ...
                <i class="fas fa-file-lines mr-1.5"></i> Generate report
            </button>
