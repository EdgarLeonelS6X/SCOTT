                    ...
                    @foreach ($reportData['channels'] as $index => $channel)
                                                            <div class="p-4 md:p-6 bg-gray-50 border dark:bg-gray-700 rounded-xl shadow-2xl">
                                                                ...
                                                                >
                                                                    ...
                                                                    <div class="relative mb-2">
                                                                        <input
                                                                            type="text"
                                                                            x-model="search"
                                                                            :placeholder="selectedChannelNumber
                                                                                ? selectedChannelNumber + ' ' + selectedChannelName
                                                                                : '{{ __('Search channel...') }}'"
                                                                            @focus="open = true"
                                                                            @input="if (search === '') clearSelection()"
                                                                        ...
                                                                        <div class="absolute left-3 top-1/2 -translate-y-1/2 flex items-center">
                                                                            <img x-show="selectedChannelImage" :src="selectedChannelImage" class="w-8 h-8 object-contain object-center" x-cloak>
                                                                        </div>
                                                                        <i
                                                                            class="fa-solid fa-chevron-down absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-300 cursor-pointer"
                                                                            :class="open ? 'rotate-180' : ''"
                                                                            @click="open = !open"
                                                                        ></i>
                                                                    </div>

                                                                    <!-- Badges con perfiles al tener canal seleccionado -->
                                                                <template x-if="selectedChannelProfiles">
                                                                    ...
                                                                    <!-- Dropdown con lista de canales -->
                                                                    <div class="relative">
                                                                        <div x-show="open" x-cloak class="absolute z-10 w-full mt-1 bg-white border rounded-lg shadow-2xl dark:bg-gray-700 transition-all">
                                                                                ...
                                                                                <template x-for="channel in filteredChannels" :key="channel.id">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <div class="flex gap-2 mt-1 text-xs">
                                                                                            <span class="px-2 py-0.5 rounded-full bg-green-300 text-green-700 dark:bg-green-800 dark:text-green-200">
                                                                                                High: <span x-text="channel.profiles?.high ?? '-'"></span>
                                                                                            </span>
                                                                                            <span class="px-2 py-0.5 rounded-full bg-yellow-300 text-yellow-700 dark:bg-yellow-800 dark:text-yellow-200">
                                                                                                Medium: <span x-text="channel.profiles?.medium ?? '-'"></span>
                                                                                            </span>
                                                                                            <span class="px-2 py-0.5 rounded-full bg-red-300 text-red-700 dark:bg-red-800 dark:text-red-200">
