                    ...
                    @foreach ($reportData['channels'] as $channelIndex => $channel)
                        <div wire:key="channel-{{ $channelIndex }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                }" x-init="@if ($selectedChannel = $channels->firstWhere('id', data_get($reportData['channels'][$channelIndex], 'channel_id'))) selectedChannelImage = '{{ $selectedChannel->image }}';
                                        selectedChannelNumber = '{{ $selectedChannel->number }}';
                                        selectedChannelName = '{{ $selectedChannel->name }}';
                                        search = selectedChannelNumber + ' ' + selectedChannelName; @endif">
