<x-app-layout>
    <div class="bg-gray-200 dark:bg-gray-900 flex items-center justify-center md:pt-4 px-4">
        <div class="bg-white dark:bg-gray-800 shadow-2xl rounded-lg p-10 max-w-xl w-full text-center">
            <div class="flex flex-col items-center gap-6">
                <i class="fas fa-search text-primary-600 dark:text-primary-400 text-6xl"></i>
                <div
                ...
                <div class="flex justify-center gap-4 w-full sm:w-auto">
                    ...
                    <a href="{{ route('dashboard') }}"
                        class="inline-flex items-center justify-center gap-2 text-gray-800 dark:text-white bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-800 font-medium rounded-md text-sm px-5 py-2.5 flex-1 sm:flex-none">
